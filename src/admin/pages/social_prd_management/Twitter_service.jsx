...
const Twitter_service = () => {
  ...
  return (
    <div className="twitter_service">
    <div className="twitter_service_wrapper">
      <div className="twitter_service_form">
        <Service_Title title="twitter" />
...
export default Twitter_service