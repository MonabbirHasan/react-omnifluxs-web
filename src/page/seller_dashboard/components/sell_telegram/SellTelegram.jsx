...
const SellTelegram = () => {
    ...
    let table = new DataTable('#telegram_page_info_table');
    ...
    return (
        <div className='selltelegram_page'>
            <section className='selling_info_form'>
                <div className="form_wrapper">
                    <FormTitle
                        text={"upload new telegram group"}
                        color={"black"}
                        size={"20px"}
                        textstyle={"uppercase"}
                        fontFamily={"fantasy"}
            ...
            <section className='selling_info_table'>
                <div className="selling_info_table_wrapper">
                    <FormTitle
                        ...
                        pr={"0"}
                    />
                    <Table responsive="sm" id='telegram_page_info_table'>
                        <thead>
                            <tr>
                                <th scope="col">
                                    img
