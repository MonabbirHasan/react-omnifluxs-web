...
const SellWebsite = () => {
  ...
  let table = new DataTable("#website_page_info_table");
  ...
  return (
    <div className="SellWebsite_page">
      <section className="selling_info_form">
        <div className="form_wrapper">
          <FormTitle
            text={"upload new website"}
            color={"black"}
            size={"20px"}
            textstyle={"uppercase"}
            fontFamily={"fantasy"}
      ...
      <section className="selling_info_table">
        <div className="selling_info_table_wrapper">
          <FormTitle
            ...
            pr={"0"}
          />
          <Table responsive="sm" id="twitter_page_info_table">
            <thead>
              <tr>
                <th scope="col">img</th>
                ...
                <td>
                  <label class="control control--checkbox">
                    <LazyLoadImage
                      ...
                      width={40}
                      height={40}
                      style={{ borderRadius: "100%", border: "3px solid #bbb" }}
                    />
