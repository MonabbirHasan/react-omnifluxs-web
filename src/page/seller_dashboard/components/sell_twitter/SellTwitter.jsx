...
const SellTwitter = () => {
    ...
    let table = new DataTable('#twitter_page_info_table');
    ...
    return (
        <div className='selltwitter_page'>
            <section className='selling_info_form'>
                <div className="form_wrapper">
                    <FormTitle
                        text={"upload new twitter group"}
                        color={"black"}
                        size={"20px"}
                        textstyle={"uppercase"}
                        fontFamily={"fantasy"}
